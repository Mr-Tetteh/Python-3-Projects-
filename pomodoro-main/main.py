...
timer_lable = Label(text="Timer", fg=GREEN, bg=YELLOW, font=(FONT_NAME, 23, "bold"))
timer_lable.grid(column=1, row=0)

canvas = Canvas(width=200, height=224, bg=YELLOW, highlightthickness=0)
tomatoes_image = PhotoImage(file="tomato.png")
canvas.create_image(100, 112, image=tomatoes_image)
